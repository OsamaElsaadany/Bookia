...
class CartCubit extends Cubit<CartState> {
  ...
  placeOrder() async {
    emit(CartLoadingState());
    var params = PlaceOrderparams(governorateId: selcetGovId, name: nameController.text, email: emailController.text, phone: phoneController.text, address: addressController.text);
